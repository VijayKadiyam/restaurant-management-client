      ...
      <v-flex xs12 sm8 md8>
        ...
        <v-card class="elevation-12"> 
          ...
          <v-card-title primary-title>
            <h3 class="headline mb-0">Edit your customer details <b>( {{ form.name }} )</b>
...
<script type="text/javascript">
  ...
  export default {
    ...
    mounted() {
      ...
      this.form.get(`/api/customers/${this.$route.params.customer_id}`)
        .then(data  =>  {
    ...
    methods: {
      ...
      updateCustomer() {
        this.form.patch(`/api/customers/${this.$route.params.customer_id}`)
          .then(data  =>  {
